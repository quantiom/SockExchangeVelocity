...
public class RunCmdChannelListener implements Consumer<ReceivedMessage>, Registerable {
    ...
    RunCmdChannelListener(SockExchangePlugin plugin, Logger basicLogger, SockExchangeApi api, CommandManager commandManager) {
    ...
    public void accept(ReceivedMessage message) {
        ...
        for (int i = 0; i < commandCount; i++) {
            ...
            this.commandManager.executeAsync(proxy.getConsoleCommandSource(), command);
        }
    }
}
